...
read.table("/Users/eersoz/Desktop/Archive_April2019/CSJ-Review/Revisions/ArabidopsisDiallele/MFPlots_MF1_fast/modelStats_out.csv",sep=",", header=T)->results.out
hs<-read.table("../heritabilities.csv", sep=",",header=T)
...
## Also create the figures for MAE and RMSE distros as well.
