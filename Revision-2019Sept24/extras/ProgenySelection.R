...
saveFileName = "IBS-20p-spencerCircle.png" # type the file Name to save here
...
saveFileName = "PhenoDist-jd.025-spencerCircle.png"
...
saveFileName = "PhenoDist-ed20-spencerCircle.png"
...
phenoMat<-read.table("phenos/phenotype-matrix.csv",header=T, sep=",")
