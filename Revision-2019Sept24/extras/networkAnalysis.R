...
setwd("/home/elhan/trifecta/DL282g2x-validation/mlm_k/05152017-HybridGWAS/stats")
list.files(pattern="outAnn-HsG.csv")->fileList
fileList<-fileList[c(2:10,1)]

# ingred results are in "/home/elhan/trifecta/DL282g2x-validation/round1_mlm_k/stats
